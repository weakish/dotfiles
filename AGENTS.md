...
| Review one commit, then fix (`r` / bare SHA / `r <sha>` → lettered report; `y`/`c` = recommended; `h`/`help` = details; `b,d,e` / `all` to fix; `review-and-fix` fixes all) | `.agents/skills/review/SKILL.md` |
